...
initialize_sprites
        ...
        jsr set_sprite_data_location
        jsr set_sprite_data
        jsr set_sprite_x_position
        jsr set_sprite_y_position
        jsr set_sprite_colors
        jsr set_sprite_double_size
        jsr set_sprite_enabled
        rts
...
set_sprite_data
        ...
        lda #255      
        ldx #63      
set_sprite_data_loop
        dex
        sta 832,X   
        bne set_sprite_data_loop      
        rts
